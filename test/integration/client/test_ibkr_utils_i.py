...
class TestHandleQuestionsI(TestCase):
    ...
    def test_multiple_orders_returned(self):
        ...
        verify_log(
            self,
            cm,
            ['While handling questions multiple orders were returned: ' + pformat(self.original_result.data)],
        )
    ...
    def test_multiple_messages_returned(self):
        ...
        verify_log(
            self,
            cm,
            ['While handling questions multiple messages were returned: ' + pformat(self.original_result.data[0]['message'])],
        )
