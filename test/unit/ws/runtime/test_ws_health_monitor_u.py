...
from ibind.ws.runtime.ws_health_monitor import WsHealthMonitor
...
class TestCheckShouldReset:
    ...
    def test_returns_true_when_heartbeat_exceeds_max_interval(self, health_monitor, mock_state_manager):
        ...
        ## Arrange
        with mock_module_time('ibind.ws.runtime.ws_health_monitor', time_sequence=[1000.0]):
...
class TestHealthOk:
    ...
    def test_returns_true_when_within_health_check_interval(self, health_monitor):
        ...
        with mock_module_time('ibind.ws.runtime.ws_health_monitor', time_sequence=[5.0]):
            ## Act
    ...
    def test_returns_true_when_check_should_reset_returns_false(self, health_monitor):
        ...
        ## Arrange
        health_monitor._last_health_check = 0
        with mock_module_time('ibind.ws.runtime.ws_health_monitor', time_sequence=[115.0]):
    ...
    def test_updates_last_health_check_on_each_interval_check(self, health_monitor):
        ...
        ## Arrange
        health_monitor._last_health_check = 0
        with mock_module_time('ibind.ws.runtime.ws_health_monitor', time_sequence=[111.0]):
