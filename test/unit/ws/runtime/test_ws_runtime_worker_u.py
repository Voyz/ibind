...
from ibind.ws.runtime.ws_event_handler import WsEventHandler
from ibind.ws.runtime.ws_health_monitor import WsHealthMonitor
from ibind.ws.runtime.ws_lifecycle import WsLifecycle
from ibind.ws.runtime.ws_runtime_worker import WsRuntimeWorker
from ibind.ws.runtime.ws_state_manager import WsState, WsStateManager
...
class TestWsRuntimeWorkerCycle:
    ...
    def test_cycle_resets_websocket_when_health_fails(self, worker, lifecycle, health_monitor):
        """_cycle resets ws when health check fails."""
        ## Arrange
        worker._lifecycle = lifecycle
        worker._running = True
    ...
    def test_cycle_does_not_reset_when_health_ok(self, worker, lifecycle, health_monitor):
        """_cycle does not reset ws when health is ok."""
        ## Arrange
        worker._lifecycle = lifecycle
