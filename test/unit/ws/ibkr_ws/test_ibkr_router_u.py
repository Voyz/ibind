...
from ibind.ibkr_ws.ibkr_router import IbkrRouter, get_ibkr_topic_event, parse_raw_message
...
class TestIbkrRouterHandleSubscribedMessage:
    ...
    def test_unhandled_event_type_logs_error(self):
        ...
        ## Act
        with patch('ibind.ibkr_ws.ibkr_router.get_ibkr_topic_event') as mock_get_event:
