...
| `PriceLadder`    | BookTrader price ladder data     | <ul><li>`account_id` (str): The account the ladder is requested for.</li><li>`conid` (str): The contract identifier the ladder applies to.</li><li>`exchange` (str \| None): The exchange echoed by IBKR, when present.</li><li>`data` (list[dict]): The price ladder rows.</li></ul> |
