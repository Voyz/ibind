...
IBIND_AUTO_REGISTER_SHUTDOWN = to_bool(
    os.environ.get("IBIND_AUTO_REGISTER_SHUTDOWN", True)
)
...
IBIND_INIT_BROKERAGE_SESSION = to_bool(
    os.environ.get("IBIND_INIT_BROKERAGE_SESSION", True)
)
...
IBIND_OAUTH1A_REST_URL = os.getenv(
    "IBIND_OAUTH1A_REST_URL", "https://api.ibkr.com/v1/api/"
)
...
IBIND_OAUTH1A_LIVE_SESSION_TOKEN_ENDPOINT = os.getenv(
    "IBIND_OAUTH1A_LIVE_SESSION_TOKEN_ENDPOINT", "oauth/live_session_token"
)
